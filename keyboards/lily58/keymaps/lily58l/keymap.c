 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, TOGGLE_BUTTON,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_EQL,
                             KC_LCTL, KC_LALT, KC_LGUI, KC_ENT,   KC_SPC,   LOWER,   RAISE, KC_MINS
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  KC_F1,   KC_F2,   KC_UP,   KC_F4,   KC_F5,   KC_F6,                     KC_BTN1,   KC_BTN2,   KC_F9,   KC_F10,  KC_F11,  KC_RBRC,
  KC_BSLS, KC_LEFT, KC_DOWN,  KC_RIGHT, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_QUOT,
  _______, _______, _______, _______, _______, _______, KC_BTN2, _______, XXXXXXX, KC_MPLY, KC_MPRV, KC_MNXT, KC_RCBR, KC_PIPE,
...
[_RAISE] = LAYOUT(
  QK_BOOTLOADER, _______, _______, _______, _______, _______,                     _______, _______, _______, _______, _______, KC_EQL,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if (keycode == TOGGLE_BUTTON && record->event.pressed) {
        is_toggled = true;
    } else {
        is_toggled = false;
    }
